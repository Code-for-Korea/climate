...
class DataSourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create data_source" do
    assert_difference("DataSource.count") do
      post data_sources_url, params: { data_source: { detail: @data_source.detail, title: @data_source.title, url: @data_source.url } }
    end
  ...
  test "should update data_source" do
    patch data_source_url(@data_source), params: { data_source: { detail: @data_source.detail, title: @data_source.title, url: @data_source.url } }
